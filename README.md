...
Frontend тестового задания для каталога книг. Реализованы публичный каталог, authentication и CRUD книг и авторов; отчёты, mock API и SMS пока не реализованы.
