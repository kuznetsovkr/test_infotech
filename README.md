...
Frontend тестового задания для каталога книг. Реализованы публичный каталог, authentication и CRUD авторов; CRUD книг, отчёты, mock API и SMS пока не реализованы.
